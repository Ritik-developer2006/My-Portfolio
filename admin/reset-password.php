...
if (!isset($_SESSION['reset_password']) || !isset($_SESSION['reset_password_time'])) {
    header("Location: index.php");
    exit;
}

if (time() - $_SESSION['reset_password_time'] > 300) {
    session_destroy();
    header("Location: index.php");
    exit;
}
    ...
    <div class="m-auto d-flex justify-content-center">
        <div class="login-box">
            ...
            <form action="#" id="resetPassword" method="POST">
                ...
                <div class="password-wrap">
                    <input type="password" class="input-glass" name="confirm_password" id="confirmPassword" placeholder="Confirm Password" required>
                    <i class="fa-solid fa-eye" id="toggleConfirmPassword"></i>
                </div>

                <button class="btn-signin reset-btn" type="submit" id="submit">Reset Password</button>
